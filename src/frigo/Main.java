		...
		while(choix == 0){
			...
			case 2: // ajouter ou enlever un aliment
				...
				case 1: // ajouter un aliment
					...
					System.out.println("En quel quantit�?");
					int qute = Integer.parseInt(sc.nextLine());

					System.out.println("Quel est sa date de p�remption?(format mm/jj/aaaa)");
					...
					case 2: // laitier
						...
						System.out.println("Quel est l'unit� de votre produit laitier (gramme, litre ou unite)");
						unite = sc.nextLine();
					...
					case 3: // Legume
						...
						System.out.println("Quel est l'unit� de votre legume (gramme ou unite)");
						unite = sc.nextLine();
						if(unite.equals("unite")){
							unite = "";
						}
